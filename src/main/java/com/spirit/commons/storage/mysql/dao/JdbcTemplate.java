...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
    ...
    protected Connection createConnectionProxy(Connection con) {
        return (Connection) Proxy.newProxyInstance(
                ...
                new JdbcTemplate.CloseSuppressingInvocationHandler(con));
    }
    ...
    public void query(String sql, RowCallbackHandler rch) throws DataAccessException {
        query(sql, new JdbcTemplate.RowCallbackHandlerResultSetExtractor(rch));
    }
    ...
    public <T> T execute(String sql, PreparedStatementCallback<T> action) throws DataAccessException {
        return execute(new JdbcTemplate.SimplePreparedStatementCreator(sql), action);
    }
    ...
    public <T> T query(String sql, PreparedStatementSetter pss, ResultSetExtractor<T> rse) throws DataAccessException {
        return query(new JdbcTemplate.SimplePreparedStatementCreator(sql), pss, rse);
    }
    ...
    public void query(PreparedStatementCreator psc, RowCallbackHandler rch) throws DataAccessException {
        query(psc, new JdbcTemplate.RowCallbackHandlerResultSetExtractor(rch));
    }

    @Override
    public void query(String sql, PreparedStatementSetter pss, RowCallbackHandler rch) throws DataAccessException {
        query(sql, pss, new JdbcTemplate.RowCallbackHandlerResultSetExtractor(rch));
    }
    ...
    public int update(String sql, PreparedStatementSetter pss) throws DataAccessException {
        return update(new JdbcTemplate.SimplePreparedStatementCreator(sql), pss);
    }
    ...
    public <T> T execute(String callString, CallableStatementCallback<T> action) throws DataAccessException {
        return execute(new JdbcTemplate.SimpleCallableStatementCreator(callString), action);
    }
