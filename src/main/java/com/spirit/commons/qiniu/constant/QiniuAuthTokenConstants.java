...
//            qiniuAuthTokenMap.get("zone1_0").put("url", "http://ohsxibjkn.bkt.clouddn.com/");
            qiniuAuthTokenMap.get("zone1_0").put("accessKey", "sUPCzn1OIT1Ei0c4v9lnQVS383X9u8CxQCB4lbhh");
            qiniuAuthTokenMap.get("zone1_0").put("secretKey", "rZ7Trx6PoUEVOSFekk3DmLK7yJ6J-w5ujZL-1qsD");
            qiniuAuthTokenMap.get("zone1_0").put("url", "http://oyvwx2f78.bkt.clouddn.com/");
        }
...
//            qiniuBucketNameMap.get("zone1_0").put("bucketname0", "for-ttx");
            qiniuBucketNameMap.get("zone1_0").put("bucketname0", "geekreader");
        }
    }
